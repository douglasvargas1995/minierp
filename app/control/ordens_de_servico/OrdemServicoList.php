...
class OrdemServicoList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $action_onEdit->setDisplayCondition('OrdemServicoList::onExibirEditar');
        ...
        $action_onDelete->setDisplayCondition('OrdemServicoList::onExibirExcluir');
        ...
        $action_OrdemServicoGerarFinanceiroForm_onEdit->setImage('fas:money-bill-wave #4CAF50');
    ...
    public static function onExibirFinanceiro($object)
    {
        try 
        {
            ...
            if(!(date('Y-m-d') > $object->data_prevista && !$object->data_fim))
            {
                return true;
            }
        }
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $style = new TStyle('right-panel > .container-part[page-name=OrdemServicoListSearch]');
