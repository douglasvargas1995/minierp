...
class ContaPagarLoteForm extends TPage
{
    ...
    public function __construct( $param = null)
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Fornecedor:", '#000000', '14px', null, '100%'),$pessoa_id],[new TLabel("Categoria:", '#000000', '14px', null, '100%'),$categoria_id],[new TLabel("Forma de pagamento:", '#000000', '14px', null, '100%'),$forma_pagamento_id]);
