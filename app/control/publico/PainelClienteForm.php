...
class PainelClienteForm extends TPage
{
    ...
    public function __construct( $param = null)
    {
        ...
        $h2 = new BElement('h2');
        $button_minhas_ordens = new TButton('button_minhas_ordens');
        ...
        $button_minhas_ordens->addStyleClass('btn_links_area_cliente');
        $button_meu_financeiro->addStyleClass('btn_links_area_cliente');

        $button_meus_pedidos->setImage('fas:boxes #FFFFFF');
        $button_minhas_ordens->setImage('fas:address-card #FFFFFF');
        ...
        $button_minhas_ordens->setAction(new TAction(['ClienteOrdemPublicoList', 'onShow'],["target_container" => "navegacao"]), "Minhas Ordens");
        ...
        $row2 = $this->form->addFields([$button_minhas_ordens],[$button_meus_pedidos],[$button_meu_financeiro]);
