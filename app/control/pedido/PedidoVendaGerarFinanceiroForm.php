...
class PedidoVendaGerarFinanceiroForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Código Pedido de Venda", null, '14px', null, '100%'),$id],[new TLabel("Cliente:", '#000000', '14px', null, '100%'),$cliente_id]);
        $row1->layout = [' col-sm-4',' col-sm-4'];

        $row2 = $this->form->addFields([new TLabel("Valor total:", '#000000', '14px', null, '100%'),$valor_total],[new TLabel("Condição de pagamento:", '#000000', '14px', null),$condicao_pagamento_id],[new TLabel("Forma de pagamento:", '#000000', '14px', null),$forma_pagamento_id]);
        $row2->layout = [' col-sm-4',' col-sm-4',' col-sm-4'];

        $row3 = $this->form->addFields([new TLabel("Data vencimento inicial:", '#000000', '14px', null),$dt_vencimento_inicial],[new TLabel(" ", null, '14px', null, '100%'),$button_gerar_contas]);
