...
class PedidoVendaKanbanFormView extends TPage
{
    ...
    public function __construct( $param = null)
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Cliente:", null, '14px', null, '100%'),$cliente_id],[new TLabel("Vendedor:", null, '14px', null, '100%'),$vendedor_id],[new TLabel("Mês:", null, '14px', null, '100%'),$mes],[new TLabel("Ano:", null, '14px', null, '100%'),$ano],[new TLabel(" ", null, '14px', null, '100%'),$button_buscar]);
