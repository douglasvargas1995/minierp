...
class DashboardPedidoVenda extends TPage
{
    ...
    public function __construct( $param = null)
    {
        ...
        $pedidos_em_elaboracao->setIcon(new TImage('fas:chart-line #ffffff'));
        ...
        $row1 = $this->form->addFields([new TLabel("Mês:", null, '12px', null, '100%'),$mes],[new TLabel("Ano:", null, '12px', null),$ano],[new TLabel(" ", null, '14px', null, '100%'),$button_buscar]);
