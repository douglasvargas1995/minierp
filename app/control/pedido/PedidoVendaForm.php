...
class PedidoVendaForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $tipo_pedido_id->addValidation("Tipo do pedido", new TRequiredValidator()); 
        $transportadora_id->addValidation("Transportadora", new TRequiredValidator()); 

        $dt_pedido->setMask('dd/mm/yyyy');
        $dt_pedido->setValue(date('d/m/Y'));
        ...
        $row2 = $this->form->addFields([new TLabel("Vendedor*:", '#000000', '14px', null, '100%'),$vendedor_id],[new TLabel("Cliente*:", '#000000', '14px', null, '100%'),$cliente_id,$cliente_nome]);
        $row2->layout = ['col-sm-6','col-sm-6'];

        $row3 = $this->form->addFields([new TLabel("Condição de pagamento*:", '#000000', '14px', null, '100%'),$condicao_pagamento_id],[new TLabel("Tipo do pedido*:", '#000000', '14px', null, '100%'),$tipo_pedido_id]);
        $row3->layout = ['col-sm-6',' col-sm-6'];

        $row4 = $this->form->addFields([new TLabel("Frete:", null, '14px', null, '100%'),$frete],[new TLabel("Transportadora*:", '#000000', '14px', null, '100%'),$transportadora_id]);
        ...
        $row7 = $this->detailFormPedidoVendaItemPedidoVenda->addFields([new TLabel("Produto*:", '#000000', '14px', null, '100%'),$pedido_venda_item_pedido_venda_produto_id,$pedido_venda_item_pedido_venda_id],[new TLabel("Valor:", null, '14px', null, '100%'),$pedido_venda_item_pedido_venda_valor]);
