...
class FaturarPedidoNotaFiscalForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $row2 = $this->form->addFields([new TLabel("Cliente:", '#000000', '14px', null, '100%'),$cliente_id],[new TLabel("Condição de pagamento", '#000000', '14px', null, '100%'),$condicao_pagamento_id]);
        ...
        $row5 = $this->detailFormNotaFiscalItemNotaFiscal->addFields([new TLabel("Produto:", '#000000', '14px', null, '100%'),$nota_fiscal_item_nota_fiscal_produto_id,$nota_fiscal_item_nota_fiscal_id],[new TLabel("Quantidade:", null, '14px', null, '100%'),$nota_fiscal_item_nota_fiscal_quantidade]);
