...
class NegociacaoEmailForm extends TPage
{
    ...
    public function __construct( $param = null)
    {
        ...
        $row1 = $this->form->addFields([new TLabel("Negociações:", '#000000', '14px', null, '100%'),$negociacoes_id,$negociacao_id]);
        $row1->layout = [' col-sm-12'];

        $row2 = $this->form->addFields([new TLabel("Template de email:", '#000000', '14px', null, '100%'),$email_template_id]);
        $row2->layout = [' col-sm-12'];

        $row3 = $this->form->addFields([new TLabel("Mensagem:", '#000000', '14px', null, '100%'),$mensagem]);
