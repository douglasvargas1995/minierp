...
INSERT INTO conta (id,pessoa_id,tipo_conta_id,categoria_id,forma_pagamento_id,pedido_venda_id,ordem_servico_id,dt_vencimento,dt_emissao,dt_pagamento,valor,parcela,obs,mes_vencimento,ano_vencimento,ano_mes_vencimento,mes_emissao,ano_emissao,ano_mes_emissao,mes_pagamento,ano_pagamento,ano_mes_pagamento,created_at,updated_at,deleted_at) VALUES (1,1,2,8,1,null,null,'2022-07-20','2022-07-20',null,150,1,'',null,null,null,null,null,null,null,null,null,null,null,null); 

INSERT INTO conta (id,pessoa_id,tipo_conta_id,categoria_id,forma_pagamento_id,pedido_venda_id,ordem_servico_id,dt_vencimento,dt_emissao,dt_pagamento,valor,parcela,obs,mes_vencimento,ano_vencimento,ano_mes_vencimento,mes_emissao,ano_emissao,ano_mes_emissao,mes_pagamento,ano_pagamento,ano_mes_pagamento,created_at,updated_at,deleted_at) VALUES (2,1,2,6,2,null,null,'2022-07-21','2022-07-20',null,250,1,'',null,null,null,null,null,null,null,null,null,null,null,null); 

INSERT INTO conta (id,pessoa_id,tipo_conta_id,categoria_id,forma_pagamento_id,pedido_venda_id,ordem_servico_id,dt_vencimento,dt_emissao,dt_pagamento,valor,parcela,obs,mes_vencimento,ano_vencimento,ano_mes_vencimento,mes_emissao,ano_emissao,ano_mes_emissao,mes_pagamento,ano_pagamento,ano_mes_pagamento,created_at,updated_at,deleted_at) VALUES (3,1,2,11,3,null,null,'2022-07-30','2022-07-01',null,300,1,'',null,null,null,null,null,null,null,null,null,null,null,null); 

INSERT INTO conta (id,pessoa_id,tipo_conta_id,categoria_id,forma_pagamento_id,pedido_venda_id,ordem_servico_id,dt_vencimento,dt_emissao,dt_pagamento,valor,parcela,obs,mes_vencimento,ano_vencimento,ano_mes_vencimento,mes_emissao,ano_emissao,ano_mes_emissao,mes_pagamento,ano_pagamento,ano_mes_pagamento,created_at,updated_at,deleted_at) VALUES (4,1,2,10,1,null,null,'2022-07-30','2022-07-01',null,400,1,'',null,null,null,null,null,null,null,null,null,null,null,null); 
