...
INSERT INTO causa (id,nome) VALUES (1,'Unidade de storage com defeito'); 

INSERT INTO causa (id,nome) VALUES (2,'Tela quebrada'); 

INSERT INTO causa (id,nome) VALUES (3,'Aste dobradiça quebrada'); 
...
INSERT INTO conta (id,pessoa_id,tipo_conta_id,categoria_id,forma_pagamento_id,pedido_venda_id,ordem_servico_id,dt_vencimento,dt_emissao,dt_pagamento,valor,valor_recebido,valor_diferenca,parcela,obs,mes_vencimento,ano_vencimento,ano_mes_vencimento,mes_emissao,ano_emissao,ano_mes_emissao,mes_pagamento,ano_pagamento,ano_mes_pagamento,created_at,updated_at,deleted_at) VALUES (1,1,2,8,1,null,null,'2022-07-20','2022-07-20',null,150,null,null,1,'',null,null,null,null,null,null,null,null,null,null,null,null); 

INSERT INTO conta (id,pessoa_id,tipo_conta_id,categoria_id,forma_pagamento_id,pedido_venda_id,ordem_servico_id,dt_vencimento,dt_emissao,dt_pagamento,valor,valor_recebido,valor_diferenca,parcela,obs,mes_vencimento,ano_vencimento,ano_mes_vencimento,mes_emissao,ano_emissao,ano_mes_emissao,mes_pagamento,ano_pagamento,ano_mes_pagamento,created_at,updated_at,deleted_at) VALUES (2,1,2,6,2,null,null,'2022-07-21','2022-07-20',null,250,null,null,1,'',null,null,null,null,null,null,null,null,null,null,null,null); 

INSERT INTO conta (id,pessoa_id,tipo_conta_id,categoria_id,forma_pagamento_id,pedido_venda_id,ordem_servico_id,dt_vencimento,dt_emissao,dt_pagamento,valor,valor_recebido,valor_diferenca,parcela,obs,mes_vencimento,ano_vencimento,ano_mes_vencimento,mes_emissao,ano_emissao,ano_mes_emissao,mes_pagamento,ano_pagamento,ano_mes_pagamento,created_at,updated_at,deleted_at) VALUES (3,1,2,11,3,null,null,'2022-07-30','2022-07-01',null,300,null,null,1,'',null,null,null,null,null,null,null,null,null,null,null,null); 

INSERT INTO conta (id,pessoa_id,tipo_conta_id,categoria_id,forma_pagamento_id,pedido_venda_id,ordem_servico_id,dt_vencimento,dt_emissao,dt_pagamento,valor,valor_recebido,valor_diferenca,parcela,obs,mes_vencimento,ano_vencimento,ano_mes_vencimento,mes_emissao,ano_emissao,ano_mes_emissao,mes_pagamento,ano_pagamento,ano_mes_pagamento,created_at,updated_at,deleted_at) VALUES (4,1,2,10,1,null,null,'2022-07-30','2022-07-01',null,400,null,null,1,'',null,null,null,null,null,null,null,null,null,null,null,null); 
...
INSERT INTO grupo_pessoa (id,nome) VALUES (8,'Técnico'); 
...
INSERT INTO pessoa (id,tipo_cliente_id,categoria_cliente_id,system_user_id,nome,documento,obs,fone,email,created_at,updated_at,deleted_at,login,senha) VALUES (1,1,5,null,'Cliente 01','111.111.111-11','','(51) 9 9813-1234','cliente@cliente.com.br',null,null,null,'',''); 

INSERT INTO pessoa (id,tipo_cliente_id,categoria_cliente_id,system_user_id,nome,documento,obs,fone,email,created_at,updated_at,deleted_at,login,senha) VALUES (2,1,7,1,'Vendedor 01','1111111','','','',null,null,null,'',''); 

INSERT INTO pessoa (id,tipo_cliente_id,categoria_cliente_id,system_user_id,nome,documento,obs,fone,email,created_at,updated_at,deleted_at,login,senha) VALUES (3,2,6,null,'Fornecedor 01','1111111','','','',null,null,null,'',''); 

INSERT INTO pessoa (id,tipo_cliente_id,categoria_cliente_id,system_user_id,nome,documento,obs,fone,email,created_at,updated_at,deleted_at,login,senha) VALUES (4,2,null,null,'Transportadora','111111111','','','',null,null,null,'',''); 

INSERT INTO pessoa (id,tipo_cliente_id,categoria_cliente_id,system_user_id,nome,documento,obs,fone,email,created_at,updated_at,deleted_at,login,senha) VALUES (5,1,1,1,'tecnico jucao','54545545454','','','',null,null,null,'',''); 
...
INSERT INTO pessoa_grupo (id,pessoa_id,grupo_pessoa_id) VALUES (5,5,8); 

SET IDENTITY_INSERT pessoa_grupo OFF; 

SET IDENTITY_INSERT problema ON; 

INSERT INTO problema (id,nome) VALUES (1,'Equipamento não liga'); 

INSERT INTO problema (id,nome) VALUES (2,'Tela azul'); 

INSERT INTO problema (id,nome) VALUES (3,'Caiu no chão'); 

INSERT INTO problema (id,nome) VALUES (4,'Cachorro mijou encima'); 
