...
ALTER TABLE estado_pedido_venda_aprovador ADD CONSTRAINT estado_pedido_venda_aprovador_63f3a87a0e9cf FOREIGN KEY (estado_pedido_venda_id) references estado_pedido_venda(id); 
ALTER TABLE estado_pedido_venda_aprovador ADD CONSTRAINT estado_pedido_venda_aprovador_63f3a87a0e9e5 FOREIGN KEY (aprovador_id) references aprovador(id); 
ALTER TABLE matriz_estado_pedido_venda ADD CONSTRAINT matriz_estado_pedido_venda_63f3a87a0ef69 FOREIGN KEY (estado_pedido_venda_origem_id) references estado_pedido_venda(id); 
ALTER TABLE matriz_estado_pedido_venda ADD CONSTRAINT matriz_estado_pedido_venda_63f3a87a0ef7e FOREIGN KEY (estado_pedido_venda_destino_id) references estado_pedido_venda(id); 
...
ALTER TABLE negociacao_historico_etapa ADD CONSTRAINT negociacao_historico_etapa_63f3a87a0f498 FOREIGN KEY (negociacao_id) references negociacao(id); 
ALTER TABLE negociacao_historico_etapa ADD CONSTRAINT negociacao_historico_etapa_63f3a87a0f4e4 FOREIGN KEY (etapa_negociacao_id) references etapa_negociacao(id); 
